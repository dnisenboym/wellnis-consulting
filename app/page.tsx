...
export default function Page() {
  // Галерея: локальные файлы + голубые fallback-изображения
  const gallery = [
    {
      local: "/fitness.jpg",
      fallback: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=1600&auto=format&fit=crop",
      alt: "Active recovery / athlete",
    },
    {
      local: "/meditation.jpg",
      fallback: "https://images.unsplash.com/photo-1518609878373-06d740f60d8b?q=80&w=1600&auto=format&fit=crop",
      alt: "Calm breath / meditation",
    },
    {
      local: "/iv-drip.jpg",
      fallback: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=1600&auto=format&fit=crop",
      alt: "IV therapy / vitamins & peptides",
    },
  ];

  // Крошечный компонент: если локальная картинка не найдена — покажем fallback
  ...
  return (
    <main className="font-sans antialiased text-zinc-900">
      ...
      <section className="mx-auto max-w-6xl px-4 py-24 text-center">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight">Build a smarter wellness stack</h1>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-6 grid md:grid-cols-3 gap-4">
          {gallery.map(({ local, fallback, alt }) => (
            <figure key={local} className="relative rounded-2xl overflow-hidden border border-zinc-200" style={{ aspectRatio: '4 / 3' }}>
